...
| Pi_Store on Pi | A platform with many physical stores, users can purchase goods on the platform and get QR codes and go to physical stores for consumption, and use PI payment.| Consumer utilities | SpringCloud/java, JS/Vue,Mysql,Mongodb,Kubernetes ,docker etc. | [pi_store-on-pi](https://github.com/pi-apps/pi_store-on-pi) | pi://brainstorm.pi/project/63c641ea731cc60885ea2f7f | (When available) | (When available) |
